...
int main(int argc, char* argv[])
{
	...
	while (1)
	{
		posInfo = WSAWaitForMultipleEvents(numofClntSock, hEventArr, FALSE, WSA_INFINITE, FALSE);	//阻塞
		startIdx = posInfo - WSA_WAIT_EVENT_0;

		for (i = startIdx; i < numofClntSock; ++i)
		{
			int sigEventIdx = WSAWaitForMultipleEvents(1, &hEventArr[i], TRUE, 0, FALSE);	//立即返回
